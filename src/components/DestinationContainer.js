      ...
      <div className="self-stretch relative rounded-3xs h-[182px] overflow-hidden">
        ...
        <div className="absolute w-[calc(100%_-_0.59px)] top-[0px] right-[0.29px] left-[0.29px] flex flex-row py-2 px-3 box-border items-start justify-start">
          ...
          <div className="relative w-[90.92px] h-[59px]" style={detailsStyle}>
            <div
              className="absolute top-[21px] left-[0px] text-19xl leading-[38px] font-baloo-bhai text-white text-right inline-block w-[90.92px]"
              style={divStyle}
            >
              {destinationName}
            </div>
            <div
              className="absolute top-[0px] left-[38.39px] text-base tracking-[0.04em] uppercase font-roboto text-white text-right inline-block w-[52.53px]"
              style={fromStyle}
            >
              from
            </div>
