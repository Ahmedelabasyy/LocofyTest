const LosAngelesBannerContainer = () => {
  return (
    <div className="self-stretch relative [background:linear-gradient(100.3deg,_#0b5ba8,_#299bd8)] h-[193px] text-left text-23xl text-white font-baloo-bhai lg:py-[21px] lg:pr-10 lg:pl-[41px] lg:box-border md:py-[21px] md:px-6 md:box-border">
      <img
...
export default LosAngelesBannerContainer;
