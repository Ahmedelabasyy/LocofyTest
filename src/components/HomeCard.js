const HomeCard = ({
  ...
  return (
    <div className="self-stretch rounded-3xs bg-cornflowerblue-400 flex flex-row items-start justify-start gap-[16px] text-left text-base text-darkslategray-300 font-roboto sm:flex-col">
      <img
